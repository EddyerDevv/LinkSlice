        ...
        {buttonArray.map((button, index) => (
          <Fragment key={index}>
            {button.href ? (
              <Link
                href={button.href}
                className="w-full flex justify-between items-center px-2 h-[2.1rem] gap-2 rounded-md cursor-pointer border-[1px] border-neutral-700 bg-neutral-900 bg-opacity-30 text-neutral-200 hover:text-emerald-300 hover:bg-neutral-600 hover:bg-opacity-20 hover:border-neutral-500  transition-colors ease-in-out duration-[.25s]"
